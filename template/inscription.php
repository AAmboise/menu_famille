...
<div class="container-fluid">
  	<div class="row justify-content-center">
    	<div class="py-2 my-5 text-center message col-5 border border-dark border-3 rounded-3">
			...
			<form action="index.php?routeur=verification" method="post">
				login&nbsp;&nbsp;=========><input type="text" name="login" value=""><br /><br />
				mot de passe&nbsp;====><input type="password" name="mdp1" value=""><br /><br />
				confirmation mdp&nbsp;=><input type="password" name="mdp2" value=""><br /><br />
				<br />
